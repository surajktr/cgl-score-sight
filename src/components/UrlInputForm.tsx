        ...
        <div className="flex gap-3">
          <div className="relative flex-1">
            ...
            <Input
              ...
              placeholder="Paste your SSC CGL response sheet URL here..."
          ...
          <Button 
            ...
            size="lg"
            className="h-14 px-8 text-base font-semibold shadow-md hover:shadow-lg transition-all"
          >
            {isLoading ? (
              <>
      ...
      <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50 border border-border/50">
        ...
        <div>
          <p className="text-sm text-muted-foreground leading-relaxed">
            <span className="font-medium text-foreground">Disclaimer:</span> This tool is for personal analysis only. 
            Ensure you have the right to access the response sheet URL you provide. 
